...
for lib in build/src/userspace/libmvgal.so* build/src/userspace/libmvgal_core.a build/src/userspace/libVK_LAYER_MVGAL.so build/src/userspace/libmvgal_d3d.so build/src/userspace/libmvgal_metal.so build/src/userspace/libmvgal_webgpu.so; do
...
[ -f build/src/userspace/mvgal-daemon ] && install -m 755 build/src/userspace/mvgal-daemon %{buildroot}%{_sbindir}/mvgald || true
...
[ -f pkg/systemd/mvgal-dbus.service ] && install -m 644 pkg/systemd/mvgal-dbus.service %{buildroot}%{_unitdir}/mvgal-daemon.service || true
